...
public class DbConn {
    ...
    public DbConn() {
        ...
        String dbAndPass = "FA19_3308_tuh41347?user=tuh41347&password=buriweiv";
        ...
        try {
            ...
            try {
                ...
                recordError("Problem getting connection:" + e.getMessage() +
                        "\n Be a dear and double check your database credentials, would you?" +
                        "\n And if you're not physically connected to cis-linux2.temple.edu,"
                                + " please make sure you're tunneled in!");
            }
        } catch (Exception e) { // cant get the driver...
            recordError("Problem getting driver:" + e.getMessage() + 
                    "\n You may want to pop over to your webmaster's bungalow and make sure they're including the mySQL connector library");
        }
    } // method
