...
public final class logonAPI_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if ((email == null) || (pw == null)) {
        list.dbError = "Cannot attempt login: UserEmail and Password must be supplied";
    } else {
        ...
        if (list.dbError.length() == 0) { // if got good DB connection,
            ...
            result = DbMods.logonFind(email, pw, dbc);

            if (result == null) {
                list.dbError = "Aww jeez that wasn't a valid user login";
                //check out this next line if there's some goofiness to login
