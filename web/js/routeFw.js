function routeFw(params) {
    ...
    function router() { // private function
        ...
        console.log("you clicked the link " + location.hash);

        // remove leading # char from clicked link string
    ...
    //this is needed so that the default pages loads from a clear cache
